...
def schoolInsert():
    ...
    return render_template("school/schoolView.html")
...
def courseInsert():
    ...
    return render_template("courses/courseView.html")
...
def scholarshipInsert():
    ...
    return render_template("scholarships/scholarshipView.html")
...
def admissionInsert():
    ...
    return render_template("admissions/admissionView.html")
...
def resultInsert():
    ...
    return render_template("results/resultView.html")
...
def feeInsert():
    ...
    return render_template("fee/feeView.html")
...
def testInsert():
    ...
    return render_template("test/testView.html")
...
def centreInsert():
    if request.method == "GET":
        ...
        return render_template("counsellingCentres/centreView.html",)
